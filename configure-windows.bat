...
set /p "SOURCE=SOURCE: "
set /p "FAST_MACD=FAST_MACD: "
set /p "SLOW_MACD=SLOW_MACD: "
set /p "SIGNAL_MACD=SIGNAL_MACD: "
set /p "RSI_LENGTH=RSI_LENGTH: "
set /p "RSI_SMOOTHING=RSI_SMOOTHING: "
set /p "RSI_SMOOTHING_TYPE=RSI_SMOOTHING_TYPE: "
set /p "RSI_HISTORY_LENGTH=RSI_HISTORY_LENGTH: "
set /p "OVERBOUGHT_TRESHOLD=OVERBOUGHT_TRESHOLD: "
set /p "OVERSOLD_TRESHOLD=OVERSOLD_TRESHOLD: "
set /p "MAX_AMOUNT=MAX_AMOUNT: "
set /p "CANCEL_PERCENTAGE=CANCEL_PERCENTAGE: "
set /p "MAX_ORDER_AGE_SECONDS=MAX_ORDER_AGE_SECONDS: "
set /p "TRADE_FEE_PERCENTAGE=TRADE_FEE_PERCENTAGE: "
set /p "MAX_ORDER_AGE_SECONDS=MAX_ORDER_AGE_SECONDS: "
set /p "TRADE_FEE_PERCENTAGE=TRADE_FEE_PERCENTAGE: "
set /p "HOLD_UNTIL_POSITIVE_TRADE=HOLD_UNTIL_POSITIVE_TRADE: "
set /p "MINIMUM_PROFIT_SELL=MINIMUM_PROFIT_SELL: "
set /p "MINIMUM_PROFIT_BUY=MINIMUM_PROFIT_BUY: "
...
(
  ...
  echo FAST_MACD=%FAST_MACD%
  echo SLOW_MACD=%SLOW_MACD%
  echo SIGNAL_MACD=%SIGNAL_MACD%
  echo RSI_LENGTH=%RSI_LENGTH%
  echo RSI_SMOOTHING=%RSI_SMOOTHING%
  echo RSI_SMOOTHING_TYPE=%RSI_SMOOTHING_TYPE%
  echo RSI_HISTORY_LENGTH=%RSI_HISTORY_LENGTH%
  ...
  echo MAX_ORDER_AGE_SECONDS=%MAX_ORDER_AGE_SECONDS%
  echo TRADE_FEE_PERCENTAGE=%TRADE_FEE_PERCENTAGE%
  echo HOLD_UNTIL_POSITIVE_TRADE=%HOLD_UNTIL_POSITIVE_TRADE%
  echo MINIMUM_PROFIT_SELL=%MINIMUM_PROFIT_SELL%
  echo MINIMUM_PROFIT_SELL=%MINIMUM_PROFIT_SELL%
